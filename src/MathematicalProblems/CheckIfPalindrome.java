...
public class CheckIfPalindrome {
    public static void main(String[] args) {
        ...
        String revPalindromString = new String(reversePalindrom); //converting StringBuilder to String. cause the 'matches' method of String class
        //will not work between String and StringBuilder.

        if(palindrom.matches(revPalindromString)){  //matches() checks if two Strings are a match. and will return true if they are a match.
